   ...
   <>
    <div name="Home" className="max-w-screen-2xl container mx-auto px-4 md:px-20 my-10">
      <div className="flex flex-col md:flex-row">
        <div className="md:w-1/2 mt-10 md:mt-20 space-y-3 order-2 md:order-1">
          ...
          <div className="flex text-2xl md:text-4xl ">
            ...
            <ReactTyped
              ...
              strings={["Developer", "Designer"]} typeSpeed={40}
              backSpeed={50}
              loop={true}
            />
          </div>
          <br />
          <p className='text-sm md:font-medium text-justify'> Highly motivated MERN stack developer I'm passionate
            about web development and proficient in MongoDB,
            Express.js, React.js, and Node.js. I am eager to learn from
            experienced professionals to further develop my skills and
        ...
        <div className="md:w-1/2 flex justify-center items-center md:mt-10 mt-5 md:order-2 order-1">
          <img src={logo} alt="" className='rounded-full shadow-md shadow-gray-600 object-center md:w-[450px] md:h-[450px]' />
        </div>
      </div>
      <br />
    </div>
